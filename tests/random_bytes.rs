...
fn random_contains_letters_uppercase_range_10_25() {
    ...
    let uppercase_count = RANDOM
        .chars()
        .filter(|c| uppercase_letters.contains(c))
        .count();
...
fn random_contains_letters_lowercase_range_10_25() {
    ...
    let lowercase_count = RANDOM
        .chars()
        .filter(|c| lowercase_letters.contains(c))
        .count();
...
fn random_contains_numbers_range_10_25() {
    ...
    let number_count =
        RANDOM.chars().filter(|c| numbers.contains(c)).count();
...
fn random_contains_special_chars_range_10_25() {
    ...
    let special_count =
        RANDOM.chars().filter(|c| special_chars.contains(c)).count();
...
fn random_contains_emojis_range_10_25() {
    ...
    let emoji_count =
        RANDOM.chars().filter(|c| emojis.contains(c)).count();
